module.exports = {
    ...
    updateProfile: 'update user_profile set mobile_number = ?,full_name = ?, full_address = ?, gender =?, dob =?, email = ? where id = ?',
    ...
    getAllBookings: "select bs.*, up.full_name, up.mobile_number from booked_services bs left join user_profile as up on up.id = bs.id_user where bs.id_user = ? and bs.status = 'Active'",
